...
class _AchievementsScreenState extends State<AchievementsScreen>
  ...
  final List<Map<String, dynamic>> _allAchievements = [
    ...
    },
    {
      ...
      'description': 'Discovered 10 hidden treasures',
      'icon': Icons.search,
      'color': Colors.amber.shade500,
      'isUnlocked': false,
      'progress': 0.4,
      'category': 'Exploration',
      'reward': 'Treasure Map x1',
    },
    {
      'title': 'Secret Realm Explorer',
      'description': 'Discovered and explored a secret realm',
      'icon': Icons.visibility,
      'color': Colors.deepPurple.shade300,
      'isUnlocked': false,
      'progress': 0.0,
      'category': 'Exploration',
      'reward': 'Teleportation Talismans x5',
    },

    // 社交类成就
    {
      'title': 'Fellow Cultivator',
      'description': 'Joined a cultivation sect',
      'icon': Icons.group_add,
      'color': Colors.blue.shade300,
      'isUnlocked': true,
      'progress': 1.0,
      'category': 'Social',
      'reward': 'Sect Contribution x100',
    },
    {
      'title': 'Renowned',
      ...
      'progress': 0.35,
      'category': 'Social',
      'reward': 'Cultivation Pills x2',
    },
    {
      'title': 'Sect Elite',
      'description': 'Reached elder rank in a sect',
      'icon': Icons.stars,
    ...
    // 收集类成就
    {
      ...
      'description': 'Collected 30 different herbs',
      'icon': Icons.eco,
      'color': Colors.green.shade500,
      'isUnlocked': false,
      'progress': 0.25,
      'category': 'Collection',
      'reward': 'Herbal Recipe x1',
    },
    {
      'title': 'Weapon Expert',
      'description': 'Collected 10 different weapons',
      'icon': Icons.shield,
      'color': Colors.blueGrey.shade600,
      'isUnlocked': false,
      'progress': 0.5,
      'category': 'Collection',
      'reward': 'Divine Weapon Blueprint x1',
    },
    {
      'title': 'Spiritual Treasure Collector',
      'description': 'Collected 5 spiritual treasures',
      'icon': Icons.diamond,
    ...
    // 终极成就
    {
      ...
      'progress': 0.0,
      'category': 'Combat',
      'reward': 'Cosmic Talisman x1',
    },
    {
      'title': 'Defying Heaven to Ascend',
      ...
      'progress': 0.0,
      'category': 'Cultivation',
      'reward': 'Ascension Pill x1',
    },
    {
      'title': 'Daoist Enlightenment',
      'description': 'Mastered all innate skills',
      'icon': Icons.light_mode,
      'color': Colors.yellow.shade700,
      'isUnlocked': false,
      'progress': 0.05,
      'category': 'Cultivation',
      'reward': 'Enlightenment Tea x3',
    },
  ];
