...
class _AIChatScreenState extends State<AIChatScreen> {
  ...
  Future<void> _loadCoinBalance() async {
    ...
    setState(() {
      _coinBalance = prefs.getInt('accountGemBalance') ?? 0;
    });
  }
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      if (mounted) {
        if (_coinBalance > 0) {
          // 如果有金币，扣除金币
          await _updateCoinBalance(_coinBalance - 1);
        }
  ...
  void _scrollToBottom() {
    if (_isDisposed) return; // 如果页面已销毁，不执行滚动
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'You\'re out of coins! Purchase more coins to continue enjoying AI Assistant conversations.',
